	...
	<view class="background">
		...
		<u-popup
			...
			<view class="popup">
				...
				<view class="popup_text">請设置姓名</view>
				<view class="center_indexs">
					<view class="flex">
						<view class="tct zuo" style="flex: 1;">
							<view class="tct_in" >
								<u-input :placeholder-style="pstyle" v-model="xinm" type="text" placeholder="姓"/>
							</view>
						</view>
						<view class="tct lef" style="flex: 2;">
							<view class="tct_tit">
							</view>
							<view class="tct_in">
								<u-input :placeholder-style="pstyle" v-model="ming" type="text" placeholder="名"/>
							</view>
						</view>
					</view>
					<!-- 按钮 -->
					<view class="tagWrapButtom" @click.stop="toname()"><span class="tagButtom">確定修改</span></view>
				</view>
			</view>
		</u-popup>
	...
	export default {
		data() {
			return {
				...
				list: [
					...
					{name: '用戶姓名',img:'../../static/images/adminSet.png'},
					{name: '屏蔽機構',img:'../../static/images/shieldSet.png',url: 'job_shield_user'},
					{name: '幫助與反饋',img:'../../static/images/helpSet.png'},
					{name: '協議',img:'../../static/images/agreementSet.png',url: 'job_agreement'},
		...
		methods: {
			...
			toname(){
				...
				console.log(this.xinm);
				this.$minApi.putmemberinfo({
					family_name:this.xinm,first_name:this.ming

	...
	<view style="background-color: #F1F3F6;height: 100%;">
		...
		<view class="content">
			<view class="content_main">
				<view v-for="item in list" class="list" @click="back(item.url, item.type)">
					<view class="list_top">
	...
	export default {
		data() {
			return {
				top_center:"協議",
				list: [
					{name: '用戶協議',img:'../../static/images/userAgreement.png',url: 'job_agreement_details',type: 1},
					{name: '隱私協議',img:'../../static/images/privacyAgreement.png',url: 'job_agreement_details',type: 2},
				]
			}
		},
		components:{

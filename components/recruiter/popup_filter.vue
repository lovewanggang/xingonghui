			...
			<view class="popup">
				...
				<view class="m_center" style="background: #FFFFFF;border-radius: 24px;">
					...
					<view style="margin-top: 24px;">
						<view class="" v-if="isnop">
							<view class="t_title flex">
								<view >
									<img style="width: 44px;height: 44px;" src="static/images/fil_xues.png" alt="">
								</view>
					...
					<view style="margin-top: 24px;">
						...
						<view class="t_title flex">
							<view >
								<img style="width: 44px;height: 44px;" src="static/images/fil_zhiwei.png" alt="">
							</view>
							<view style="margin-left: 16px;">
								<view class="">
									年資要求
					...
					<view style="margin-top: 24px;" v-if="isbtnac">
						...
						<view class="t_title flex">
							<view >
								<img style="width: 44px;height: 44px;" src="static/images/fil_zili.png" alt="">
							</view>
							<view style="margin-left: 16px;">
								<view class="">
									職級要求
						...
						<view class="flex" style="align-items: center;margin-top: 24px;">
							<view class="t_money">
								<img v-if="isnop == 11" @click="isnopo(11,1)" src="static/images/checked.png" alt="">
								<img v-if="isnop!=11" @click="isnopo(11,1)" src="static/images/oval.png" alt="">
								普通員工
							</view>
							<view class="t_money">
								<img v-if="isnop !=22" @click="isnopo(22,2)" src="static/images/oval.png" alt="">
								<img v-if="isnop==22" @click="isnopo(22,2)" src="static/images/checked.png" alt="">
								基層管理
							</view>
						</view>
						<view class="flex" style="align-items: center;margin-top: 24px;">
							<view class="t_money">
								<img v-if="isnop ==33" @click="isnopo(33,3)" src="static/images/checked.png" alt="">
								<img v-if="isnop!=33" @click="isnopo(33,3)" src="static/images/oval.png" alt="">
								中層管理
							</view>
							<view class="t_money">
								<img v-if="isnop !=44" @click="isnopo(44,4)" src="static/images/oval.png" alt="">
								<img v-if="isnop ==44" @click="isnopo(44,4)" src="static/images/checked.png" alt="">
								高層管理
							</view>
...
<style scoped>
	...
	.isbtnac{
		margin: 3px;
		background: linear-gradient(180deg, #5091EF 2%, #2B599B 100%);
		border-radius: 12px;
	}
	.aactrn{
